    ...
    mpMap(pMap)
{
    ...
    //mKcld=boost::shared_ptr<PointTCloud>(new PointTCloud);
    //mKcld=Converter::rangeToPointCloud(F.depthImg,F.RGBImg,mK);
...
//
//        vector<KeyFrame*>::iterator it = lower_bound( mvOrderedWeights.begin(),   //起点
//                                                mvOrderedWeights.end(),     //终点
//                                                w);
