...
public:
    ...
    Tracking(System* pSys, ORBVocabulary* pVoc, FrameDrawer* pFrameDrawer, Map* pMap,
             KeyFrameDatabase* pKFDB, const string &strSettingPath, const int sensor,float viewangle=60.0);
...
protected:
   ...
   /**
    ...
    list<Frame> mlHistroyFrame;
    //the max camera view angle
    float mviewAngle;
};  //class Tracking
