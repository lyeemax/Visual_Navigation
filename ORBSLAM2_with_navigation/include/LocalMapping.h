...
public:
    ...
    void InsertPointCloud(KeyFrame *KF,cv::Mat depthImg,cv::Mat rgbImg);
...
protected:
    ...
    void PointCloudCulling();

    void GenerateFullPointCloudMap();
    ...
    ////the first is frame id
    map<KeyFrame* ,PointTCloudPtr> mlCloudPool;
};
